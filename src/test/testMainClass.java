...
public class testMainClass {
	...
	private static String inputDirPath = "人工标注数据";
	private static String outputDirPath = "测试报告输出";	
    ...
    public static void main(String[] args) throws IOException {
    	...
    	FileOutputStream report = new FileOutputStream(new File(userDir+"\\"+outputDirPath+"\\"+"测试报告"+time+".txt")); ;     
    	...
    	double[] similarityThresholds = {0.95, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2,0.1, 0};  
    	...
    	for (int i = 0; i < similarityThresholds.length; i++) {
    		...
    		SimilarityHandler SH = new SimilarityHandler(testPair);
    		int hitNum = 0;
    		int emptyNum = 0;
    		for (Map.Entry<String, String> entry : predictPair.entrySet()) { 
    			String mostSimilarityOne = SH.getLabel(entry.getKey(), similarityThresholds[i]);
    		...
    		report.write(("完全命中率 :"+String.valueOf(hitNum*1.0/predictTotal)+"\r\n").getBytes());
